...
from city_garden.city_garden_nodes import analyze_garden_conditions, generate_final_output, check_compliance
...
def build_garden_graph():
    ...
    garden_graph.add_edge("generate_final_output", END)
